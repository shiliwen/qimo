...
int main()
{
	...
	outfile.close();
	cout<<"list_SIMD_SSE:";
	gettime(search_list_SIMD_SSE,t_query,idx);
	cout<<"list_SIMD_AVX:";
	gettime(search_list_SIMD_AVX,t_query,idx);
	cout<<"element_SIMD_SSE:";
	gettime(search_element_SIMD_SSE,t_query,idx);
	cout<<"element_SIMD_AVX:";
	gettime(search_element_SIMD_AVX,t_query,idx);
	cout<<"list_bit_SIMD_SSE:";
	gettime(search_list_bit_SIMD_SSE,t_query,idx);
	cout<<"list_bit_SIMD_AVX:";
	gettime(search_list_bit_SIMD_AVX,t_query,idx);
	cout<<"element_bit_SIMD_SSE:";
	gettime(search_element_bit_SIMD_SSE,t_query,idx);
	cout<<"search_element_bit_SIMD_AVX:";
	gettime(search_element_bit_SIMD_AVX,t_query,idx);
	return 0;
}